...
public class ApiMarvelConsumer {
	...
	// retorna uma pagina inicial com um limite de personagens definido pelo
	// parâmetro "limit=" na baseUrl.
	...
	public ModelAndView buscaPersonagem(@RequestParam("buscar") String nomeCharacterBusca) {
		...
		String baseUrlBusca = "http://gateway.marvel.com/v1/public/characters?nameStartsWith=" + nomeCharacterBusca
				+ "&limit=100&ts=1&apikey=ce97fad4a20c632bde78b471943aac47&hash=5217adf0ea0dd8d977e005be283d9115";
	...
	public ModelAndView seriesRelacionadas(int idPersonagem) {
		...
		String urlSeries = "http://gateway.marvel.com/v1/public/characters/" + idPersonagem
				+ "/series?limit=100&ts=1&apikey=ce97fad4a20c632bde78b471943aac47&hash=5217adf0ea0dd8d977e005be283d9115";
